...
class Purchaser(models.Model):
    ...
    nip = models.PositiveIntegerField(default=0,  null=True, blank=True)
    vat = models.PositiveIntegerField(default=0, null=True, blank=True)
    ...
    smid = models.CharField(max_length=200, null=True, blank=True)
